module.exports = {
    ...
    init: [
        ...
        {type: 'circle-move-coin', /*x: 150, y: 150,*/ coinAmount: 3, r: 20, currentPoint: 0.5, path: [{x: 10, y: 10}, {x: 490, y: 10}, {x: 490, y: 490}, {x: 0, y: 490}], bounciness: 180, speed: 1},
        {type: 'circle-move-coin', /*x: 150, y: 150,*/ coinAmount: 10, r: 20, currentPoint: 1, path: [{x: 10, y: 10}, {x: 490, y: 10}, {x: 490, y: 490}, {x: 0, y: 490}], bounciness: 180, speed: 1},
