module.exports = {
    ...
    init: [
        {type: 'settings', dimensions: {x: 1000, y: 800}, spawn: {x: 500, y: 750}, difficulty: 'Peaceful'},// settings obstacle will always be the first obstacle, otherwise default to saved settings
