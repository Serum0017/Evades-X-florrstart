module.exports = {
    ...
    init: [
        ...
        {type: 'square-normal-changeVinette', vinetteToChange: {outer: {color: {r: 20, g: 0, b: 0}, size: 0.05, alpha: 0}, inner: {color: {r: 0, g: 0, b: 0}, size: 0.02, alpha: 1}}, x: 400, y: 325, w: 100, h: 50, eventEmitters: [{type: 'timePassed', maxTime: 1, currentTime: 1, id: 0}]},
        // {type: 'square-normal-changeSpeed', speedMult: 0.1, x: 400, y: 325, w: 100, h: 50},
        {type: 'square-normal-normal', x: 250, y: 300, w: 50, h: 50, eventRecievers: [{id: 0, type: 'changeParameter', keyChain: ['x'], addValue: 1.5}]},
