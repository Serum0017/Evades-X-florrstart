const { Rock, EvilFlower, Diep, MopeMouse } = require('./Enemy.js');
...
const enemyTypes = ['rock', 'evilflower', 'diep', 'mopemouse'];
...
module.exports = class Spawner {
    constructor(points, rarity, dimensions, roomLocation, forceEnemyType=null){
        ...
        this.maxTimer = 1000+spawnTimePerRarity[this.rarity]*(Math.random()+1/3);
