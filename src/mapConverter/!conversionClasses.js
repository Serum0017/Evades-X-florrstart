...
class RotatingLava {
	constructor(x, y, w, h, spd, angle=0, pivotX, pivotY, distToPivot, canCollide) {
        ...
        return {
            ...
            x:x+w/2,y:y+h/2,w,h,rotateSpeed: spd/1000,rotation: angle, /*pivot: {x: pivotX, y: pivotY},*/ solid: canCollide
        }
	}
}
...
class BouncyObstacle {
	constructor(x, y, w, h, effect=30) {
        ...
        return {
            ...
            x:x+w/2,y:y+h/2,w,h,bounciness: effect, friction: 0.8
        }
	}
}
...
class CircularBouncyObstacle {
	constructor(x, y, r, effect=30) {
		return {
            ...
            x,y,r,bounciness: effect, friction: 0.8
        }
	}
}
...
class GravObstacle {
    constructor(x, y, w, h, dir, force = 500){
        ...
        return {
            ...
            x:x+w/2,y:y+h/2,w,h,
            conveyorForce: force/10000,
            conveyorAngle: Math.atan2(this.dir.y,this.dir.x)
        }
    }
}
...
class MovingObstacle {
    constructor(w, h, points = [[50, 50]], speed = 30, currentPoint=0, alongWith = false){
        return {
            ...
            x: points[currentPoint][0],y: points[currentPoint][1],w,h,
            speed:speed*60/1000,currentPoint,
            path: points.map(p => {return {x: p[0], y: p[1]}})
        }
    }
}
