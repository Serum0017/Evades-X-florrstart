...
function render(){
    ...
    if(window.disconnected){
        if(window.won === true){
            ...
            ctx.lineWidth = 3;
            if(Math.random() < 0.1){
                ctx.strokeText('Lol get Disconnected Noob xD', canvas.width/2, canvas.height/2 - 70);
                ctx.fillText('Lol get Disconnected Noob xD', canvas.width/2, canvas.height/2 - 70);
            } else {
