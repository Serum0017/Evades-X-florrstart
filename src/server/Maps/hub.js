module.exports = {
    ...
    init: [
        ...
        {type: 'text-rotate-snapGrid', rotation: 0, pivot: {x: 0, y: 0}, rotateSpeed: .1, text: 'Evades X', fontSize: 30, x: 0, y: 0, snapDistance: {x: 35, y: 60}, snapAngle: 45, snapAngleRotateSpeed: 0.2, isGround: false},
    ]
}