module.exports = {
    ...
    init: [
        ...
        // {type: 'square-normal-changeShape', frictionValue: 0.9, x: 0, y: 250, w: 1000, h: 500, shapeType: 'square', shapeWidth: 50, shapeHeight: 50},
        ...
        },
        {
            ...
            eventRecievers: [{id: 3, type: 'changeParameter', keyChain: ['radiusMult'], multiplyValue: 1/150}]
        },
